 ...
 * @author dark_
 */
public class multiplicadorConstante extends javax.swing.JInternalFrame {
    ...
    public multiplicadorConstante() {
        ...
        ///----------------///----- ETIQUETAS -----///---------------///
        etiq_tituloMultiplicadorConstante_.setFont(tipoFuente.fuente(tipoFuente.GOD,0,24));
        ///----------------///----- CUADROS DE TEXTO -----///---------------///
    ...
    private void initComponents() {
        ...
        etiq_tituloMultiplicadorConstante_ = new javax.swing.JLabel();
        ...
        txt_constante_ = new javax.swing.JTextField();
        ...
        etiq_tituloMultiplicadorConstante_.setText("MULTIPLICADOR CONSTANTE");
        ...
        etiq_semilla2_.setText("Constante:");
        ...
        layout.setHorizontalGroup(
                    ...
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                                ...
                                .addComponent(txt_constante_, javax.swing.GroupLayout.PREFERRED_SIZE, 68, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addComponent(btn_aleatorio2_, javax.swing.GroupLayout.Alignment.TRAILING)))
                    .addGroup(layout.createSequentialGroup()
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addComponent(etiq_tituloMultiplicadorConstante_)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(etiq_semilla2_)
                    .addComponent(txt_constante_, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(etiq_semilla_))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(btn_aleatorio1_)
    ...
    private void btn_aleatorio2_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_aleatorio2_ActionPerformed
        if( !"".equals(txt_cantidadDigitos2_.getText()) && isNumeric(txt_cantidadDigitos2_.getText()) && Double.parseDouble(txt_cantidadDigitos2_.getText()) > 3  ){
            ...
            txt_constante_.setText(String.valueOf(valorEntero));
        }else{
    ...
    private void btn_calcular_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_calcular_ActionPerformed
        ...
        if( !"".equals(txt_cantidadDigitos1_.getText()) && !"".equals(txt_cantidadDigitos2_.getText()) && !"".equals(txt_cantidadNumeros_.getText()) && !"".equals(txt_semilla_.getText()) && !"".equals(txt_constante_.getText())  ){

            if( isNumeric(txt_cantidadDigitos1_.getText()) && isNumeric(txt_cantidadDigitos2_.getText()) && isNumeric(txt_cantidadNumeros_.getText()) && isNumeric(txt_semilla_.getText()) && isNumeric(txt_constante_.getText()) ){

                if( Double.parseDouble(txt_cantidadDigitos1_.getText()) > 0 && Double.parseDouble(txt_cantidadDigitos2_.getText()) > 0 && Double.parseDouble(txt_cantidadNumeros_.getText()) > 0  && Double.parseDouble(txt_semilla_.getText()) > 0 && Double.parseDouble(txt_constante_.getText()) > 0 ){

                    int cantNum = Integer.parseInt(txt_cantidadNumeros_.getText());
                    int semilla = Integer.parseInt(txt_semilla_.getText());
                    int constante = Integer.parseInt(txt_constante_.getText());
                    ...
                    while( constante !=0 ) //cuenta los digitos de un numero
                    {
                    ...
                    System.out.println("cantidad digitos en semilla  "+digitos1+" pedidos por usuario "+cantDigitos1+" cantidad digitos en constante "+digitos2+" pedidos por usuario "+cantDigitos2);
                        ...
                        for(int fila=0;fila<=cantNum;fila++){ // recorrido de filas
                            ...
                            for(int col=0;col<5;col++){ // recorrido de columnas
                                ...
                                switch(col) {
                                    ...
                                    if(fila==0){
                                        BigInteger n1,n2;
                                        n1 = new BigInteger( txt_semilla_.getText() );
                                        n2 = new BigInteger( txt_constante_.getText() );
                                        numeros[col] = new BigInteger(n1.multiply(n2).toString()); //elevado al cuadrado
                                        sNumeros[col] = String.valueOf(numeros[col]);
                                        System.out.println("valor en arreglo "+sNumeros[col]);
                                    }else{
                                        BigInteger n1,n2;
                                        n1 = new BigInteger( txt_constante_.getText() );
                                        //n2 = new BigInteger( modelo.getValueAt(fila, col-1).toString() );\
                                        n2 = new BigInteger( numeros[col-1].toString() );
                                        numeros[col] = new BigInteger(n1.multiply(n2).toString()); //elevado al cuadrado
                                        sNumeros[col] = String.valueOf(numeros[col]);
                                        System.out.println("valor en arreglo "+sNumeros[col]);
                                    }
    ...
    public String exportar(File archivo, JTable tablaD){
        ...
        Sheet hoja = wb.createSheet("multiplicadorConstante");
    ...
    private javax.swing.JLabel etiq_tituloMultiplicadorConstante_;
    ...
    private javax.swing.JTextField txt_constante_;
