 ...
 * @author dark_
 */
public class lineal extends javax.swing.JInternalFrame {
    ...
    public lineal() {
        ...
        ///----------------///----- ETIQUETAS -----///---------------///
        etiq_tituloLineal_.setFont(tipoFuente.fuente(tipoFuente.GOD,0,24));
        ///----------------///----- BOTONES -----///---------------///
        btn_comprobarC_.setVisible(false);
        ///----------------///----- TABLA MENU -----///---------------///
        tabla_lineal_.setEnabled(false);
    ...
    private void initComponents() {
        ...
        etiq_tituloLineal_ = new javax.swing.JLabel();
        jScrollPane1 = new javax.swing.JScrollPane();
        tabla_lineal_ = new javax.swing.JTable();
        ...
        etiq_constanteC_ = new javax.swing.JLabel();
        txt_constanteC_ = new javax.swing.JTextField();
        btn_comprobarC_ = new javax.swing.JButton();
        ...
        etiq_tituloLineal_.setText("LINEAL");

        tabla_lineal_.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        jScrollPane1.setViewportView(tabla_lineal_);
        ...
        etiq_constanteC_.setText("Constante C:");

        btn_comprobarC_.setText("Comprobrar C");
        btn_comprobarC_.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btn_comprobarC_ActionPerformed(evt);
            }
        });
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(etiq_tituloLineal_)
                            .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                    ...
                                    .addGroup(layout.createSequentialGroup()
                                        ...
                                        .addGap(49, 49, 49)
                                        .addComponent(etiq_constanteC_)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(txt_constanteC_, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE)
                                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                        .addComponent(btn_comprobarC_)))))
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(etiq_semilla_)
                    .addComponent(btn_comprobarC_)
                    .addComponent(txt_constanteC_, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(etiq_constanteC_))
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
    ...
    private void btn_calcular_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_calcular_ActionPerformed
        if ( validarTxtVacios() && validarTxtNumericos() && validarTxtPositivos()  ) {
            ...
            if ( cFlag ) {
                ...
                int a = Integer.parseInt( txt_a_.getText() );
                ...
                int c = Integer.parseInt( txt_constanteC_.getText() );
                //int k = Integer.parseInt( txt_constanteK_.getText() ); 
                int finFilas = 2;
                
                modelo = new DefaultTableModel();
                modelo2 = new DefaultTableModel();
                tabla_lineal_.setModel(modelo);
                        ...
                        switch(col) {
                            ...
                            case 1:// la columna del numero x o semillas
                                if(fila==0){
                                    ...
                                    int x = ((a*Integer.parseInt( modelo.getValueAt(fila-1, col).toString() ))+c)%m;
                                    sNumeros[col] = String.valueOf(x);
                                    System.out.println("valor en arreglo "+sNumeros[col]);
                                }
                            break;
                ...
                JOptionPane.showMessageDialog(rootPane, " Comprobar con el boton constante C ");
            }
    ...
    private void btn_comprobarC_ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_comprobarC_ActionPerformed
        if ( validarIndividual( txt_constanteC_.getText() ) ) {
            int n1 = Integer.parseInt(txt_constanteC_.getText());
            int n2 = Integer.parseInt(txt_m_.getText());       
            if( MCD(n1, n2) == 1 ){
                cFlag = true;
                JOptionPane.showMessageDialog(rootPane, " Correcto C es primo relativo de M ");
            }else{
                cFlag = false;
                JOptionPane.showMessageDialog(rootPane, " ERROR C y M NO son primos relativos");
            }
        } else {
            JOptionPane.showMessageDialog(rootPane, " Debe existir la variable M (eme) ");
        }
    }//GEN-LAST:event_btn_comprobarC_ActionPerformed
    ...
    public String exportar(File archivo, JTable tablaD){
        ...
        Sheet hoja = wb.createSheet("algoritmoLineal");
    ...
    private  boolean validarTxtVacios(){
        ...
        if( txt_constanteC_.getText().isEmpty() ) return false;
    ...
    private  boolean validarTxtPositivos(){
        ...
        if( Integer.parseInt(txt_constanteC_.getText()) < 0 ) return false;
    ...
    private  boolean validarTxtNumericos(){
        ...
        if( !isNumeric( txt_constanteC_.getText()) ) return false;
    ...
    private javax.swing.JButton btn_comprobarC_;
    public javax.swing.JButton btn_exportar_1;
    private javax.swing.JLabel etiq_a_;
    private javax.swing.JLabel etiq_constanteC_;
    ...
    private javax.swing.JLabel etiq_tituloLineal_;
    private javax.swing.JScrollPane jScrollPane1;
    private javax.swing.JScrollPane jScrollPane2;
    private javax.swing.JTable tabla_lineal_;
    private javax.swing.JTable tabla_numerosAleatorios_;
    private javax.swing.JTextField txt_a_;
    private javax.swing.JTextField txt_constanteC_;
